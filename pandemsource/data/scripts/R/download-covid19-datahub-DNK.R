library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country DNK")
df <- covid19(country = c("DNK"), level = 3)
...
message("getting covid-19 datahub data done for country DNK done")
