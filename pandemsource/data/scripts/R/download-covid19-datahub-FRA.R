library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country FRA")
df <- covid19(country = c("FRA"), level = 3)
...
message("getting covid-19 datahub data done for country FRA done")
