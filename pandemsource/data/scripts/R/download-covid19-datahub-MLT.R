library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country MLT")
df <- covid19(country = c("MLT"), level = 3)
...
message("getting covid-19 datahub data done for country MLT done")
