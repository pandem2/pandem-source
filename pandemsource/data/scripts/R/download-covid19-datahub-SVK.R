library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country SVK")
df <- covid19(country = c("SVK"), level = 3)
...
message("getting covid-19 datahub data done for country SVK done")
