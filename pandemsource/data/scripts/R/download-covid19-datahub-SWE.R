library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country SWE")
df <- covid19(country = c("SWE"), level = 3)
...
message("getting covid-19 datahub data done for country SWE done")
