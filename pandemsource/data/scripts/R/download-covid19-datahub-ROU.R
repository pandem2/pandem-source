library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country ROU")
df <- covid19(country = c("ROU"), level = 3)
...
message("getting covid-19 datahub data done for country ROU done")
