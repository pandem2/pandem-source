library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country GBR")
df <- covid19(country = c("GBR"), level = 3)
...
message("getting covid-19 datahub data done for country GBR done")
