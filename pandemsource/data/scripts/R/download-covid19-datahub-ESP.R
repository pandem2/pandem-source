library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country ESP")
df <- covid19(country = c("ESP"), level = 3)
...
message("getting covid-19 datahub data done for country ESP done")
