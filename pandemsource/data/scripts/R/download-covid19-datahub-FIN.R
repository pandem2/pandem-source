library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country FIN")
df <- covid19(country = c("FIN"), level = 3)
...
message("getting covid-19 datahub data done for country FIN done")
