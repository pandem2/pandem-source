library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country GRC")
df <- covid19(country = c("GRC"), level = 3)
...
message("getting covid-19 datahub data done for country GRC done")
