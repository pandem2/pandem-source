library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country AUT")
df <- covid19(country = c("AUT"), level = 3)
...
message("getting covid-19 datahub data done for country AUT done")
