library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country LUX")
df <- covid19(country = c("LUX"), level = 3)
...
message("getting covid-19 datahub data done for country LUX done")
