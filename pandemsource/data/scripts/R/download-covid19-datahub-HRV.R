library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country HRV")
df <- covid19(country = c("HRV"), level = 3)
...
message("getting covid-19 datahub data done for country HRV done")
