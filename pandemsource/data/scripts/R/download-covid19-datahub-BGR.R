library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country BGR")
df <- covid19(country = c("BGR"), level = 3)
...
message("getting covid-19 datahub data done for country BGR done")
