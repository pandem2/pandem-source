library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country LVA")
df <- covid19(country = c("LVA"), level = 3)
...
message("getting covid-19 datahub data done for country LVA done")
