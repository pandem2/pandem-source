library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country HUN")
df <- covid19(country = c("HUN"), level = 3)
...
message("getting covid-19 datahub data done for country HUN done")
