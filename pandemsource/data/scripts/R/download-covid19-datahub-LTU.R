library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country LTU")
df <- covid19(country = c("LTU"), level = 3)
...
message("getting covid-19 datahub data done for country LTU done")
