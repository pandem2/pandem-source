library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country CYP")
df <- covid19(country = c("CYP"), level = 3)
...
message("getting covid-19 datahub data done for country CYP done")
