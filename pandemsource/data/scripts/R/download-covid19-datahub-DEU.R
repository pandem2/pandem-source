library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country DEU")
df <- covid19(country = c("DEU"), level = 3)
...
message("getting covid-19 datahub data done for country DEU done")
