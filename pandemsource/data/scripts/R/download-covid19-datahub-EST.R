library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country EST")
df <- covid19(country = c("EST"), level = 3)
...
message("getting covid-19 datahub data done for country EST done")
