library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country NLD")
df <- covid19(country = c("NLD"), level = 3)
...
message("getting covid-19 datahub data done for country NLD done")
