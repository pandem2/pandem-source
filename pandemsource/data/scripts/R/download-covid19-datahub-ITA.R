library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country ITA")
df <- covid19(country = c("ITA"), level = 3)
...
message("getting covid-19 datahub data done for country ITA done")
