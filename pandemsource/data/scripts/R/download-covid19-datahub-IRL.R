library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country IRL")
df <- covid19(country = c("IRL"), level = 3)
...
message("getting covid-19 datahub data done for country IRL done")
