library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country SVN")
df <- covid19(country = c("SVN"), level = 3)
...
message("getting covid-19 datahub data done for country SVN done")
