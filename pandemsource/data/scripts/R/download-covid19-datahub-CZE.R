library(dplyr)
library(COVID19)
message("getting data for covid19datahub for Country CZE")
df <- covid19(country = c("CZE"), level = 3)
...
message("getting covid-19 datahub data done for country CZE done")
