...
def do_reset(args, *other):
  ...
  if args.notations or args.restore_factory_defaults:
    admin.reset_source("nuts-eurostat", delete_data = args.delete_data)
    admin.reset_source("ICD-10-diseases", delete_data = args.delete_data)
    admin.reset_source("isco-08-ilo", delete_data = args.delete_data)
  if args.pandem_partners_template or args.restore_factory_defaults:
    admin.reset_source("covid19-template-cases", delete_data = args.delete_data)
    admin.reset_source("covid19-template-cases-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-cases-THL", delete_data = args.delete_data)
    admin.reset_source("covid19-template-beds-staff", delete_data = args.delete_data)
    admin.reset_source("covid19-template-contact-tracing", delete_data = args.delete_data)
    admin.reset_source("covid19-template-daily-voc-voi", delete_data = args.delete_data)
    admin.reset_source("covid19-template-daily-voc-voi-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-hospitalised-deaths", delete_data = args.delete_data)
    admin.reset_source("covid19-template-hospitalised-deaths-THL", delete_data = args.delete_data)
    admin.reset_source("covid19-template-hospitalised-deaths-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-ltcf-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-outbreaks", delete_data = args.delete_data)
    admin.reset_source("covid19-template-participatory-sentinel-surveilla", delete_data = args.delete_data)
    admin.reset_source("covid19-template-sex-age-comorbidity", delete_data = args.delete_data)
    admin.reset_source("covid19-template-testing", delete_data = args.delete_data)
    admin.reset_source("covid19-template-testing-THL", delete_data = args.delete_data)
    admin.reset_source("covid19-template-testing-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-vaccination", delete_data = args.delete_data)
    admin.reset_source("covid19-template-vaccination-THL", delete_data = args.delete_data)
    admin.reset_source("covid19-template-voc-voi", delete_data = args.delete_data)
    admin.reset_source("covid19-template-local-regions", delete_data = args.delete_data)
    admin.reset_source("covid19-template-local-regions-RIVM", delete_data = args.delete_data)
    admin.reset_source("covid19-template-local-regions-THL", delete_data = args.delete_data)
  if args.covid19_datahub or args.restore_factory_defaults:
    admin.reset_source("covid19-datahub", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-AUT", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-BEL", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-BGR", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-HRV", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-CYP", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-CZE", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-DNK", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-EST", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-FIN", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-FRA", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-DEU", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-GRC", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-HUN", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-IRL", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-ITA", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-LVA", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-LTU", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-LUX", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-MLT", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-NLD", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-POL", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-PRT", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-ROU", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-SVK", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-SVN", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-ESP", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-SWE", delete_data = args.delete_data)
    admin.reset_source("covid19-datahub-GBR", delete_data = args.delete_data)

  if args.ecdc_covid19_simulated or args.restore_factory_defaults:
    admin.reset_source("ecdc-covid19-age-group-variants", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-weekly-hospital-occupancy-variants", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-genomic-data", delete_data = args.delete_data)
  if args.ecdc_covid19 or args.restore_factory_defaults:
    admin.reset_source("ecdc-covid19-vaccination", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-variants", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-age-group", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-measures", delete_data = args.delete_data)
    admin.reset_source("ecdc-covid19-weekly", delete_data = args.delete_data)
  ...
  if args.influenzanet or args.restore_factory_defaults:
    admin.reset_source("influenza-net", delete_data = args.delete_data)
    admin.reset_source("influenza-net-visits", delete_data = args.delete_data)
  if args.twitter or args.restore_factory_defaults:
    admin.reset_source("twitter", delete_data = args.delete_data)    
  if args.medisys or args.restore_factory_defaults:
    admin.reset_source("medisys", delete_data = args.delete_data)
  if args.flights or args.restore_factory_defaults:
    admin.reset_source("ourairports", delete_data = args.delete_data)
    admin.reset_source("ourairports-of-origin", delete_data = args.delete_data)
    admin.reset_source("opensky-network-coviddataset", delete_data = args.delete_data)
  if args.airports or args.restore_factory_defaults:
    admin.reset_source("ourairports", delete_data = args.delete_data)
    admin.reset_source("ourairports-of-origin", delete_data = args.delete_data)
  if args.owid or args.restore_factory_defaults:
    admin.reset_source("owid-covid19-excess-mortality", delete_data = args.delete_data)
  if args.geonames or args.restore_factory_defaults:
    admin.reset_source("geonames-countries", delete_data = args.delete_data)
    admin.reset_source("geonames-countries-of-origin", delete_data = args.delete_data) 
  if args.health_resources_eurostat or args.restore_factory_defaults:
    admin.reset_source("health-resources-national-eurostat", delete_data = args.delete_data)
    admin.reset_source("health-resources-nuts2-eurostat", delete_data = args.delete_data)
    admin.reset_source("health-resources-beds-eurostat", delete_data = args.delete_data)
  if args.pandem_2_2023_fx or args.restore_factory_defaults:
    admin.reset_default_folders("input-local", delete_data = args.delete_data)
    admin.reset_source("pandem-2-2023-fx-DEU", delete_data = args.delete_data)
    admin.reset_source("pandem-2-2023-fx-NLD", delete_data = args.delete_data)
